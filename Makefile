...
alphavm: ./avm/loader.cpp
	g++ -std=c++11 ./avm/loader.cpp ./avm/avm.cpp ./avm/dispatcher.cpp ./avm/executors/assign.cpp ./avm/executors/arithmetic.cpp ./avm/executors/function.cpp ./avm/executors/table.cpp ./avm/executors/jump.cpp  -o alphavm$(EXE_EXTENSION)
